...
namespace AudioPlaybackAgent1
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        public List<AudioTrack> _playList = new List<AudioTrack>
        {
            new AudioTrack(new Uri("https://api.soundcloud.com/tracks/62722711/stream?consumer_key=d61f17a08f86bfb1dea28539908bc9bf"), "A note", null, null, null, "", EnabledPlayerControls.All),
        ...
        public List<AudioTrack> latestsongs = new List<AudioTrack> (10);
        ...
        public AudioPlayer()
        {
            ...
            latestsongs.Add(BackgroundAudioPlayer.Instance.Track);
            ...
            switch (action)
            {
                case UserAction.Play:
                    if (PlayState.Playing != player.PlayerState)
                    {
                        ...
                        {
                            //player.Track = BackgroundAudioPlayer.Instance.Track;
                            //player.Play();
        ...
        {
            if (++currentTrackNumber >= latestsongs.Count)
            {
            ...
            // Specify the track
            return latestsongs[currentTrackNumber];
        }
        ...
        private AudioTrack GetPreviousTrack()
        {
            if (--currentTrackNumber < 0)
            {
                ...
                currentTrackNumber = latestsongs.Count - 1;
            }
